...
There are [many other testimonial plugins](http://wordpress.org/extend/plugins/search.php?q=testimonials) which use custom post types - have a look and see if one is suitable for your needs.
If you are a developer and would like to continue development of this plugin, [contact me](http://www.benhuson.co.uk/contact/) and I will set you up with commit access.**
